...
/**
 * POST /api/tools/ppc-page-analyser/check-urls
 * Check which URLs already have PPC page analysis results for a client.
...
export async function POST(request: NextRequest) {
  try {
    ...
    const existingAnalyses = await PpcPageAnalysis.find(
      {
        clientId,
        url: { $in: urls },
      },
